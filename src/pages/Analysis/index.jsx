...
export default function Analysis() {
    ...
    async function fetchComplaint() {
        ...
        updateFieldHandler('ticketID', location.pathname.split('/')[2]);
        updateFieldHandler('clerkDescription', fetchedComplaint.result.clerkDescription);
        updateFieldHandler('level', fetchedComplaint.result.level);
        updateFieldHandler('status', fetchedComplaint.result.status); 
    }
